...
// GetDesc / GetDesc1 are inline passthrough in the header now — the
// vendor spoof moved to the dxgi.dll vtable hot-patch
// (adapter_vtable_hooks.cpp) which catches all GetDesc callers including
// system d3d11's internal use, without the layout-sniff crash that
// wrapping the adapter caused.
